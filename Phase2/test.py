...
exp = 980228491662149 - 1 - 883028336485156

print((FastExpo(579556293495205, exp, 980228491662149) * 717578653316009) % 980228491662149)
print((FastExpo(316345791561668, exp, 980228491662149) * 520407507216903) % 980228491662149)
